...
export const TABLES: TableConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "spam_restrict_seconds", label: "Mute trong bao lâu", type: "number", section: "Chống spam" },
      ...
      { key: "duplicate_message_enabled", label: "Chặn nội dung lặp", type: "boolean", section: "Chống spam" },
      { key: "duplicate_message_max_count", label: "Số lần lặp tối đa", type: "number", section: "Chống spam" },
      { key: "duplicate_message_window_seconds", label: "Khung thời gian tính lặp", type: "number", section: "Chống spam" },
      { key: "duplicate_message_action", label: "Xử lý nội dung lặp", type: "select", options: ["delete", "warn", "ban"], section: "Chống spam" },
      { key: "duplicate_message_reason", label: "Lý do nội dung lặp", type: "textarea", section: "Chống spam" },
      { key: "warning_text", label: "Mẫu cảnh báo chung", type: "textarea", section: "Mẫu tin kiểm duyệt" },
      { key: "forward_warning_reason", label: "Lý do cảnh báo forward", type: "textarea", section: "Mẫu tin kiểm duyệt" },
      ...
      { key: "warning_notice_delete_seconds", label: "Tự xóa cảnh báo chung sau", type: "number", section: "Mẫu tin kiểm duyệt" },
      { key: "forward_warning_delete_seconds", label: "Tự xóa cảnh báo forward sau", type: "number", section: "Mẫu tin kiểm duyệt" },
      { key: "spam_notice_delete_seconds", label: "Tự xóa tin mute sau", type: "number", section: "Mẫu tin kiểm duyệt" },
      { key: "bio_link_warning_text", label: "Mẫu cảnh báo bio có link", type: "textarea", section: "Mẫu tin kiểm duyệt" },
      { key: "bio_link_notice_delete_seconds", label: "Tự xóa cảnh báo bio sau", type: "number", section: "Mẫu tin kiểm duyệt" },
