...
export const TABLES: TableConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      enabled,
      { key: "moderation_enabled", label: "Bật kiểm duyệt", type: "boolean", section: "Kiểm duyệt", helper: "Tắt để group này không chạy moderation." },
      ...
      { key: "spam_max_messages", label: "Số tin spam tối đa", type: "number", section: "Luật spam", helper: "Số tin trong khung thời gian trước khi bot xử lý." },
      { key: "spam_window_seconds", label: "Khung thời gian spam", type: "number", section: "Luật spam", helper: "Đơn vị: giây. 12 = 12 giây, 300 = 5 phút." },
      { key: "spam_action", label: "Xử lý spam", type: "select", options: ["delete", "warn", "ban"], section: "Luật spam", helper: "warn = xóa tin vi phạm + cảnh báo." },
      { key: "spam_restrict_seconds", label: "Mute trong bao lâu", type: "number", section: "Luật spam", helper: "Đơn vị: giây. 300 = 5 phút." },
      { key: "forward_action", label: "Xử lý forward", type: "select", options: ["delete", "warn", "ban"], section: "Luật spam", helper: "warn = xóa tin vi phạm + cảnh báo." },
      { key: "inline_keyboard_action", label: "Xử lý bài có nút", type: "select", options: ["delete", "warn", "ban"], section: "Luật spam", helper: "warn = xóa tin vi phạm + cảnh báo." },
      { key: "ban_after_warnings", label: "Ban sau số cảnh báo", type: "number", section: "Luật spam", helper: "Ví dụ 3 = ban sau 3 lần cảnh báo." },
      { key: "duplicate_message_enabled", label: "Chặn nội dung lặp", type: "boolean", section: "Luật spam" },
      { key: "duplicate_message_max_count", label: "Số lần lặp tối đa", type: "number", section: "Luật spam", helper: "Số lần gửi trùng cho phép." },
      { key: "duplicate_message_window_seconds", label: "Khung thời gian tính lặp", type: "number", section: "Luật spam", helper: "Đơn vị: giây. 600 = 10 phút." },
      { key: "duplicate_message_action", label: "Xử lý nội dung lặp", type: "select", options: ["delete", "warn", "ban"], section: "Luật spam", helper: "warn = xóa tin vi phạm + cảnh báo." },
      { key: "duplicate_message_reason", label: "Lý do nội dung lặp", type: "textarea", section: "Luật spam", helper: "Lý do cố định, không cần placeholder." },
      { key: "warning_text", label: "Mẫu cảnh báo chung", type: "textarea", section: "Mẫu tin kiểm duyệt" },
      { key: "forward_warning_reason", label: "Lý do cảnh báo forward", type: "textarea", section: "Mẫu tin kiểm duyệt", helper: "Lý do cố định, không cần placeholder." },
      { key: "forward_warning_text", label: "Mẫu cảnh báo forward", type: "textarea", section: "Mẫu tin kiểm duyệt" },
      { key: "spam_restrict_text", label: "Mẫu tin khi mute/restrict", type: "textarea", section: "Mẫu tin kiểm duyệt" },
      { key: "warning_notice_delete_seconds", label: "Tự xóa cảnh báo chung sau", type: "number", section: "Mẫu tin kiểm duyệt", helper: "Đơn vị: giây. 180 = 3 phút." },
      { key: "forward_warning_delete_seconds", label: "Tự xóa cảnh báo forward sau", type: "number", section: "Mẫu tin kiểm duyệt", helper: "Đơn vị: giây. 180 = 3 phút." },
      { key: "spam_notice_delete_seconds", label: "Tự xóa tin mute sau", type: "number", section: "Mẫu tin kiểm duyệt", helper: "Đơn vị: giây. 30 = nửa phút." },
      { key: "scan_bio_links", label: "Quét link trong bio", type: "boolean", section: "Bio, link & cảnh báo", helper: "Bật để bot quét bio người gửi." },
      { key: "bio_link_delete_message", label: "Xóa tin khi bio có link", type: "boolean", section: "Bio, link & cảnh báo", helper: "Xóa tin vi phạm nếu bio chứa link." },
      { key: "bio_link_restrict_seconds", label: "Mute khi bio có link", type: "number", section: "Bio, link & cảnh báo", helper: "0 = giữ restrict cho tới khi admin mở lại." },
      { key: "bio_scan_cache_seconds", label: "Cache quét bio", type: "number", section: "Bio, link & cảnh báo", helper: "Đơn vị: giây. 3600 = 1 giờ." },
      { key: "bio_link_warning_text", label: "Mẫu cảnh báo bio có link", type: "textarea", section: "Bio, link & cảnh báo" },
      { key: "bio_link_notice_delete_seconds", label: "Tự xóa cảnh báo bio sau", type: "number", section: "Bio, link & cảnh báo", helper: "Đơn vị: giây. 30 = nửa phút." },
